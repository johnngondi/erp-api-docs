# Pending Tasks API — Landlord Portal

Base route:

`/api/v1/landlord/pending-tasks`
...
- `GET /api/v1/landlord/pending-tasks`
...
```json
{
  "data": [
    {
      "id": 88,
      "title": "Confirm your remittance details",
      "description": "A remittance is ready and needs your bank details confirmed.",
      "user_group_id": 6,
      "user_group": { "id": 6, "title": "landlord", "label": "Landlord" },
      "taskable_type": "App\\Models\\FacilityRemittance",
      "taskable_id": 9,
      ...
      "resource_type": "FacilityRemittance",
      "resource_id": 9,
