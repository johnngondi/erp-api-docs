# Alerts API — Landlord Portal

Base route:

`/api/v1/landlord/alerts`
...
```json
{
  "data": [
    {
      "id": 12,
      "title": "A remittance is awaiting your confirmation",
      "notes": "Remittance #9 for Riverside Apartments is ready.",
      "priority": { "value": "high", "color": "danger", "label": "High" },
      "user_group_id": 6,
      "alertable_type": "App\\Models\\FacilityRemittance",
      "alertable_id": 9,
      "active_until": {
