# Pending Tasks API — Tenant Portal

Base route:

`/api/v1/tenant/pending-tasks`
...
- `GET /api/v1/tenant/pending-tasks`
  ...
  "data": [
    {
      ...
      "description": "Your application cannot be vetted until the document is in.",
      "user_group_id": 2,
      "user_group": { "id": 2, "title": "tenant", "label": "Tenant" },
      "taskable_type": "App\\Models\\LeaseApplication",
      "taskable_id": 77,
      ...
      "resource_id": 77,
      "resource_url": "https://api.example.com/api/v1/tenant/lease-applications/77"
    }
  ],
