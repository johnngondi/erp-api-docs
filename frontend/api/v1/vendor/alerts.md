# Alerts API — Vendor Portal

Base route:

`/api/v1/vendor/alerts`
...
```json
{
  "data": [
    {
      "id": 12,
      "title": "A jobcard is outstanding",
      "notes": "LPO LPO-00123 was delivered but has no jobcard against it.",
      "priority": { "value": "high", "color": "danger", "label": "High" },
      "user_group_id": 4,
      "alertable_type": "App\\Models\\FacilityProcurementLpo",
      "alertable_id": 12,
      "active_until": {
