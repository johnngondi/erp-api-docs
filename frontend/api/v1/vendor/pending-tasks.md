# Pending Tasks API — Vendor Portal

Base route:

`/api/v1/vendor/pending-tasks`
...
- `GET /api/v1/vendor/pending-tasks`
...
- Sorts: `sort=due_at|created_at` (prefix with `-` to reverse). Defaults to newest first.
...
```json
{
  "data": [
    {
      "id": 88,
      "title": "Upload jobcard for LPO LPO-00123",
      "description": "Upload the signed jobcard for Rewire the lobby once the work is done.",
      "user_group_id": 4,
      "user_group": { "id": 4, "title": "vendor", "label": "Vendor" },
      "taskable_type": "App\\Models\\FacilityProcurementLpo",
      "taskable_id": 12,
      ...
      "resource_type": "FacilityProcurementLpo",
      "resource_id": 12,
